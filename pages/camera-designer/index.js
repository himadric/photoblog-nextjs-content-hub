...
export async function getStaticProps() {
  ...
  if(client) {
    ...
    const intro = await Helper.getPageIntro(client, "Camera Designer Page Intro");
    const blogList =  await Helper.getBlogsFromCollection(client, "Camera Designer", "camera-designer");
